...
for(var r=(t-1)*z,i=s?3*p:0,d=document.createDocumentFragment(),c=r+i,l=t===a?e.reward_total:t*z;l>c;c++)w(d,n?window.defaultAvatarUrl:A[c]);
return!s&&(o.innerHTML=""),o.appendChild(d),s=!1,n?function(){
for(var e=o.getElementsByClassName("reward_user_avatar"),t=i,n=e.length;n>t;t++)e[t].firstElementChild.src=A[r+t];
}:!1;
};
...
t=s>H&&0>=a?!1:H>s&&a+r>=i?!1:!0,t||e.preventDefault();
}
},K=function(){
...
T.sendLock=!1,I.hide(),t&&t.base_resp&&0===t.base_resp.ret?(o(),q(),weui.toast("Posted",1e3)):d(e.length);
},
error:function(){
